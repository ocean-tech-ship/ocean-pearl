...
export default {
    ...
    head: {
        ...
        meta: [
            ...
            { hid: 'twitter:description', property: 'twitter:description', content: 'Community-based project tracking platform for the Ocean ecosystem with an early focus on the OceanDAO community.' },
